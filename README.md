...
사진을 올리고 목소리로 그 순간을 말하면 Whisper가 전사합니다.
...
| **AI** | OpenAI Whisper `whisper-1` STT · gpt-4o-mini 캡션 편집과 이미지 감정 분류 |
...
**AI 파이프라인**
Whisper로 전사하고 말투를 살려 캡션으로 다듬습니다.
편집이 실패하면 전사 원문을 그대로 남깁니다. 침묵하거나 지어내지 않습니다.

**모바일 웹 클라이언트**
React 19와 TypeScript로 만든 SPA입니다.
