...
class Photo(Base):
    ...
    transcript: Mapped[str | None] = mapped_column(Text, nullable=True)  # Whisper가 받아쓴 원문
    caption: Mapped[str | None] = mapped_column(Text, nullable=True)  # 받아쓴 말을 다듬은 캡션. 사용자가 고칠 수 있다
